...
cout << "Este programa le permitirá realizar diferentes operaciones con grafos." << endl;

GRAFO grafito (nombrefichero, errorapertura);

if (grafito.dirigido != 0 && grafito.dirigido != 1){
cout << "ERROR EN EL ARCHIVO" << endl;
return 0;
}

while (grafito.dirigido == 0 || grafito.dirigido == 1){
